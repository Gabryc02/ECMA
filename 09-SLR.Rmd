...
abline funziona solo se prima fai firare plot, perchè è una funzione di secondo livello.
I residuals sono gli errori rimasti fuori dall'analisi di regressione
Coefficients=-17.57 indica l'intercetta, ovvero l'intersezione della retta con l'asse y.
Speed è il coefficiente angolare. Si calcola il t-value per vedere se speed è significativamente diverso da 0, per vedere se la retta ha un'inclinazione.
Pr(>|t|) deve essere minore di 0,05 perchè sarebbe il p-value e si riferisce alla significatività del t-test.
